...
typedef struct
{
    ...
    uint16_t             *rxBufLen;                 /*!< Receive INF data length in Bytes         */
...
typedef struct
{
    ...
    uint16_t             *rxBufLen;                 /*!< Received INF data length in Bytes         */
    bool                 *isRxChaining;             /*!< Received data is not complete            */
 ...
 * 
 * Initialize the ISO-DEP protocol layer 
 ******************************************************************************
 */
 ...
 *   
 *  \param[in]  compMode  : compliance mode: ISO10373 or other
 *  \param[in]  FSDI      : Frame Size Device Integer to be used
 *  \param[in]  DID       : Device ID to be used or RFAL_ISODEP_NO_DID for not use DID
