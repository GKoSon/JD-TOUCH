...
2021/12/09 昨天正式释放了程序！注意到我做复制15693的卡的逻辑虽然可以但是不能开门 因为我们里面有UID的判断 效果是我复制了 也不能开门了  还是需要研究加密的事情 本次提交是del复制卡的逻辑代码 对比前提交很清楚

2021/12/16安装工APP安装会死机--因为名字我PB去解析需要明确知道过来的数据多大，我只能大不能少。安装围墙机正常 因为它的名字就是围墙机 安装门禁机死机 因为它过来的名字很长是二栋二单元XX这样 这个bug就是我放弃解析 因为目前这个字段没有意义！
