...
void st25_hal_init( void )
{
	...
	{
		log(DEBUG,"RFAL initialization succeeded..\n");
	}
	else
	{
		log(WARN,"RFAL initialization failed..\n");
	}

}


//MODULES_INIT_EXPORT(st25_hal_init , "ST25R3911");
...
tagObjType	st25Tag = 
{
	...
	.cqBus_read_data = st25ReadChongQingBusCardData,
	.apdu_select_app = apduSelectApp,
	.write_and_read_app = st25WriteMessageToPhone,
