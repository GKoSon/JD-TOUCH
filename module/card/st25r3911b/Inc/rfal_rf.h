...
#define RFAL_1FC_IN_4096FC                         4096             /*!< Number of 1/fc cycles in one 4096/fc */
#define RFAL_1FC_IN_512FC                          512              /*!< Number of 1/fc cycles in one 512/fc  */
#define RFAL_1FC_IN_64FC                           64               /*!< Number of 1/fc cycles in one 64/fc   */
#define RFAL_1FC_IN_8FC                            8                /*!< Number of 1/fc cycles in one 8/fc    */
#define RFAL_BITS_IN_BYTE                          8                /*!< Number of bits in one byte           */
#define RFAL_US_IN_MS                              1000             /*!< Number of us in one ms               */
#define RFAL_1MS_IN_1FC                            13560            /*!< Number of 1/fc cycles in 1ms         */
...
enum {
    RFAL_FDT_LISTEN_NFCA_POLLER      = 1108,   /*!< FDTA,LISTEN,MIN (n=9) Last bit before EoF is Logic "1"  Digital 1.1  6.10 ;  EMV CCP Spec Book D v2.01  4.8.1.3 */
...
typedef enum {
    RFAL_COMPLIANCE_MODE_NFC_10,   /*!< Perform with NFC Forum 1.0 compliance */
    RFAL_COMPLIANCE_MODE_NFC_11,   /*!< Perform with NFC Forum 1.1 compliance */
 ...
 *
 * \return rfalTrasceiveState : the current Transceive internal State
 *****************************************************************************
 */
