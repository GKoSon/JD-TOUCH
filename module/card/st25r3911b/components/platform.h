...
#define ST25R3911_SS_PIN            SPI1_CS_Pin         /*!< GPIO pin used for ST25R3911 SPI SS                */ 
#define ST25R3911_SS_PORT           SPI1_CS_GPIO_Port   /*!< GPIO port used for ST25R3911 SPI SS port          */ 
...
******************************************************************************
*/
#define platformIrqST25R3911Disable()                 HAL_NVIC_DisableIRQ(EXTI1_IRQn);              /*!< Disables ST353911 MCU's external interrupt  */
#define platformIrqST25R3911Enable()                  HAL_NVIC_EnableIRQ(EXTI1_IRQn);               /*!< Enables ST353911 MCU's external interrupt   */
